	...
	<div id="container">
        ...
        <form  name="myform" method="post" action="">
            ...
            <div id="first_step">
				...
				<input class="submit" type="submit" onclick="document.pressed=this.value"/>
            ...
            <div id="fourth_step">
                ...
                <input class="send submit" type="submit" name="submit_fourth" id="submit_fourth" value="d"  onclick="document.pressed=this.value" />            
            </div>
            </form>
