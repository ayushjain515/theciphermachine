...
<link rel="stylesheet" href="css/quotes_crawling.css" type="text/css" media="all">
...
<li>
<a href="contactus.php"> <p1> CONTACT US </p1>
</a>
</li>
</ul> 
</div>
<div class="content">
<h1> <b>Random Crypto Quotes</b></h1>
<?php
include_once('simple_html_dom.php');
$target_url = "http://en.wikiquote.org/wiki/Cryptography";
$html = new simple_html_dom();
$html->load_file($target_url);
$count=0;
//echo <h1> Quantum Cryptography </h1>
//foreach($html->find('h3[class=post-title]') as $post){
//echo $post."<br/>";
//$_POST(find('div[align=justify]')) as $content;
//echo $content."<p>";
//}
//foreach($html->find('img') as $image){
//echo $image."<br/>";}
//foreach($html->find('div[class=title]') as $post){
//echo $post;
//$hello=($html->find('div[class=title]'));
//foreach($hello->find('h2') as $heading){
//echo $heading;
//}
$i=(rand(1,50));
$j=$i;
/*foreach($html->find('ui') as $var1)
{
foreach($var1->find('li') as $var2)
{
 echo $var2 ;
 }*/
 if($j%2==0){
...
$var4=$html->find('li',$i+2);
echo $var4;
}
else{
$var4=$html->find('li',$i+1);
echo $var4;
$j++;
}
...
$j++;*/
//$var1=$html->find('li',$i);
//$var2=$html->find('li',$i+1);
//echo $var1."</br>";
//echo $var2."<br/>";
/*foreach($var1->find('h2',$i) as $var3)
{
echo $var3;
}*/
//$count=$count+1;
//if($count>0){
/*
$var=$html->find('div[class=entry]',$i);
// $hello=$var->find('p');
 echo $var;*/
// $j++;
 
 /*
   foreach($html->find('div[class=entry]') as $var)  
	{
	 echo $var;
	$hello=$var->find('p');
...
/*
foreach($html->find('div[class=entry]') as $var){
foreach($var->find('p') as $hello){
echo $hello;
}}*/
//}
//echo $post."<br/>";
//foreach($e= $html->find('div[align=justify]') as $hello){
//echo $hello->outertext;
//$e = $html->find('div[class="post-body"]');
//foreach($e = $html->find('div[class="post-body"]') as $hello){
//foreach($hello->find('a') as $answer){
//echo $answer."<br/>";
//}
//}
//foreach($html->find('div[align=justify]') as $content){
//echo $content."<p>";
//foreach($e = $html->find('text') as $testo){
//echo $testo."<br/>";
//$e= $html->find('div[align=justify]');
?>
<a href="http://localhost/project/quotes_crawling.php"><img src="reload.png" /> </img></a>
</div>
