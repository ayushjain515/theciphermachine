...
<link rel="stylesheet" href="css/implementingcrawler2.css" type="text/css" media="all">
...
<div class="content">
<h1> <b>Crawled Articles </b></h1>
<?php
include_once('simple_html_dom.php');
$target_url = "http://jonkatz.wordpress.com/";
...
//}
$i=2;
/*foreach($html->find('div[class=title]') as $var1)
{*/
if($i==3)
break;
$var1=$html->find('div[class=title]',$i);
echo $var1;
...
?>
<a href="http://localhost/project/implementingcrawler3.php"><img src="next-button-dc348.jpg"> </img></a>
</div>
