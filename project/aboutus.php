...
<h1> ABOUT US </h1>
 <p>The Cipher Machine is a website on a mission. We are a non-profit, e-learning website with a goal to provide the world with the best available information on the subject of Cryptography. The main aim with which the website is started is to eradicate the old methodologies of teaching and replace them with current trend in the education sector.
With the most recent way of learning watching video tutorials , analyzing the concepts through the means of images rather than just simple plain text learning and evolving through them.The teaching mechanism adopted doesn't restrict itself here but goes beyond with inclusion of means like using twitter based learning and information sharing through the means of blogs. <a href="<?php $link12 = whattoshowh(); echo $link12?>"> HOME </a> </p>
</div>
