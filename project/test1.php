...
$random = $pgno*2 + rand(1,2);
$qno = "q" . ($pgno + 1);
$qn = "q" . $pgno;
$ano = "a" . $pgno; 
$ans = $_REQUEST['sol'];

mysql_query("INSERT INTO result ( ".$qno." ) VALUES (".$random.")");
mysql_query("UPDATE result SET ".$ano." = ".$ans." WHERE ".$qno." = ".$qn);

$result = mysql_query("SELECT * FROM ques WHERE QNo = '$random'" );
...
<li>
<a href="page3.html"> <p1> CIPHER </p1>
</a>
</li>
<li>
<a href="page4.html"> <p1> HASH FUNCTION </p1>
</a>
</li>
<li>
<a href="test1.php?pg=$pgno"> <p1> QUIZZES </p1>
</a>
</li>
<li>
...
<form name="QUE1" action="test1.php?pg=<?php echo $pgno ?>" method="post">

<h1><?php echo $row['QNo'] . ".) " . $row['que']; ?><br />
  <input type="radio" name="sol" value="a" /> <?php echo $row['a']; ?><br />
  <input type="radio" name="sol" value="b" /> <?php echo $row['b']; ?><br />
  <input type="radio" name="sol" value="c" /> <?php echo $row['c']; ?><br />
  <input type="radio" name="sol" value="c" /> <?php echo $row['d']; ?><br />
</h1>
