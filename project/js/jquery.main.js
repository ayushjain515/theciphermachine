    ...
    $('#submit_first').click(function(){
       ...
       var fields = $('#first_step input[type=text], #first_step input[type=password]');
        ...
        fields.each(function(){
			...
			var check=value.match(/the/gi);
			var check1=value.match(/cip/gi);
			var check2=value.match(/mac/gi);
								 //alert(value);

			//	if(value!=check || value!=check1 || value!=check2)
			if(check!="the" && check1!="cip" && check2!="mac")
				{
				$(this).addClass('error');
                $(this).effect("shake", { times:3 }, 150);
