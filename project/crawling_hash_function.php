...
<div class="content">
<h1> <b>Hash Functions</b></h1>
<?php
include_once('simple_html_dom.php');
$variable=$_POST["hashfunction"];
$target_url = "http://www.fileformat.info/tool/hash.htm?text=$variable";
//echo $target_url;
$html = new simple_html_dom();
$html->load_file($target_url);
$count=0;
foreach($html->find('table[class=grid]') as $hello){
foreach($hello->find('td') as $output){
echo $output;
echo "</br>";
}
}
