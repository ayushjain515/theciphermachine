...
<header> FAQs </header>
<div class="faqs">
<p1> 1. What is cryptography? </p1>
</br>
<p2> Ans. The science of encryption or an art of hiding information in any form of media. </p2>
</br>
</br>
<p1> 2. What is meant by cipher? </p1>
<br/>
<p2> Ans. In the field of cryptography, a cipher refers to the algorithm applied for performing an encryption i.e a series of well defined steps to be followed as a procedure. </p2>
</br>
</br>
<p1> 3. What are the areas of application of cryptography? </p1>
<br/>
<p2> Ans.It can be applied in the field of generation of hash functions, providing more secure encryption of passwords  and is most applicable in the segment of network design and implementation. </p2>
</br>
</br>
<p1> 4. What is the difference between public and private key cryptography ? </p1>
<br/>
<p2> Ans. Key used by the encryptor is public key and the key used by the decryptor to track back the original message is private key.</p2>
