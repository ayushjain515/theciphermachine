...
<?php echo $lin2; ?>
  ...
  <a href="samepagefinal.php"><img src="images\back.jpg" /></a>
...
?>
<a href="videos.php?pg=<?php echo $coun ?>"><img src="images\stop.jpg" id ="pqr" /></a>
...
?>
<a href="videos.php?pg=<?php echo $coun ?>"><img src="images\start.jpg" id="abcd"  /></a>
</div>
</div>
...
<p class="copyright" align="center"> <br/>A product of <a href="samepagefinal.php" target="_blank">The Cipher Machine.</a> No Cipher was broken in process of making this website. </p>
<br />
<ul> 
<li><h4>The Cipher Machine</h4></li>  
<li><a href="samepagefinal.php">Home</a></li> 
<li><a href="videos.html">Videos</a></li> 
<li><a href="samepagefinalhindi.php">Hindi</a></li> 
